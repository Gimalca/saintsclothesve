...
<!--Mega Manu Css Start-->
<!--<link rel="stylesheet" type="text/css" href="view/stylesheet/pavmegamenubase.css" />
<link rel="stylesheet" type="text/css" href="view/stylesheet/pavmegamenubase/widget.css" />-->
<!--Mega Manu Css Start-->
...
<!--Mega Manu js Start-->
<script type="text/javascript" src="view/javascript/pavmegamenubase/jquery.nestable.js"></script>
<script type="text/javascript" src="view/javascript/pavmegamenubase/jquerycookie.js"></script>
<!--Mega Manu js End-->
...
<div id="container">
  ...
  <div id="menu">
    <ul class="left" style="display: none;">
      ...
      <!--VQ START-->
      <!--VQ END-->
<li id="help"><a class="top"><?php echo $text_vigo; ?></a>
      	<ul>
        	<li><a href="<?php echo $vigo_configuration; ?>"><?php echo $text_vigo_configuration; ?></a></li>
            <li><a href="<?php echo $vigo_slider; ?>"><?php echo $text_vigo_slider; ?></a></li>
			<li><a href="<?php echo $vigo_banner; ?>"><?php echo $text_vigo_banner; ?></a></li>
			<li><a href="<?php echo $vigo_color; ?>"><?php echo $text_vigo_color; ?></a></li>
