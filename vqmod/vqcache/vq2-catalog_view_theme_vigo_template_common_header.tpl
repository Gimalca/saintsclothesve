...
<link rel="stylesheet" type="text/css" href="catalog/view/theme/<?php echo $this->config->get('config_template'); ?>/stylesheet/popup_notification_addtocart.min.css" />
                    ...
                    <div class="for-desktop">
                        <div class="form-search for-not-tablet">
                         ...
                         <div class="social-icons" style="margin-top:7px">
                            ...
                            <a class="instragram-icon" title="Instragram" href="https://www.instagram.com/saints_ve/">Instragram</a>
