...
<link rel="canonical" href="<?php echo $link['rel']; ?>" />
                    ...
                    <div class="for-desktop">
                        ...
                        <div class="form-search for-not-tablet">
                         ...
                         <div class="social-icons" style="margin-top:7px">
                            ...
                            <a class="facebook-icon" title="Facebook" href="https://www.facebook.com/saintsparaguay/">Facebook</a>

                            <a class="twitter-icon" title="Twitter" href="https://twitter.com/saints_paraguay?lang=en">Twitter</a>

                            <a class="instragram-icon" title="Instragram" href="https://www.instagram.com/saints_paraguay/">Instragram</a>
