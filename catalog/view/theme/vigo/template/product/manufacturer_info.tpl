			...
			<div class="category-products">
                ...
                <div class="">
                	<div class="sorter">
                        ...
                        <div class="view-mode">
                        <label><?php echo $text_display; ?></label>
                        <strong class="list" title="List"><?php echo $text_list; ?></strong>
                        <a class="grid" title="Grid" onclick="display('grid');"><?php echo $text_grid; ?></a>
                   		</div>
                        <div class="limiter">
