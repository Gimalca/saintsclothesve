...
<div id="content" class="main-container col2-right-layout"><?php echo $content_top; ?>
  ...
  <div class="main container">
      ...
      <input type="text" name="search" value="<?php echo $search; ?>" class="input-text required-entry"  placeholder="<?php echo $entry_search; ?>....*"/>

      <?php } else { ?>

      <input type="text" name="search" value="<?php echo $search; ?>" onclick="this.value = '';" onkeydown="this.style.color = '000000'" style="color: #999;" class="input-text required-entry"  placeholder="<?php echo $entry_search; ?>....*"/>
      ...
      <?php } ?>
        ...
        <input type="checkbox" name="sub_category" value="1" id="sub_category" checked="checked" class="checkbox"/>

        <?php } else { ?>

        <input type="checkbox" name="sub_category" value="1" id="sub_category" class="checkbox"/>
    	...
    	<input type="checkbox" name="description" value="1" id="description" checked="checked" class="checkbox"/>

        <?php } else { ?>

        <input type="checkbox" name="description" value="1" id="description" class="checkbox"/>
        ...
        <label for="description"><?php echo $entry_description; ?></label>
                        ...
                        <button id="button-search" class="button" value="<?php echo $button_search; ?>" type="button">

	                        <span><span><?php echo $button_search; ?></span></span>
