                ...
                <div class="col-md-2" id="posicion-footer">
                    ...
                    <ul>
                        ...
                        <ul>
                             ...
                             <li id="tamaño"><a href="" data-toggle="modal" data-target="#myModal">Tabla de Tallas</a></li>
               		...
               		<div class="block block-login-info">
                            ...
                            <form action="" name="suscribe" id="news_subscribe" >
                                ...
                                <div class="block-content">
                                    ...
                                    <h2 id="subscribe_result" style="  padding-top:5px; font-size:14px; color: green"></h2>
